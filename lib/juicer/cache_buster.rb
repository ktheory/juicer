...
class Juicer::CacheBuster
  ...
  # argument.
  #
  def self.path(file, parameter = "cb", type = :soft)
  ...
  #
  def self.hard(file, parameter = "cb")
    self.path(file, parameter, :hard)
  end
  ...
  # parameter name "cb" (as in *c*ache *b*uster).
  #
  def self.soft(file, parameter = "cb")
    self.path(file, parameter, :soft)
  end
  ...
  # "cb" by default.
  #
  def self.clean(file, parameter = "cb")
