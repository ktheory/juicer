...
class AssetTest < Test::Unit::TestCase
  context "initializing asset" do
    should "create asset with default options" do
      ...
      assert_equal Dir.pwd, asset.options[:context]
      assert_equal "", asset.options[:host]
      assert_nil asset.options[:document_root]
    end

    should "create asset with overridden options" do
      context = "/home/me/project/awesome-site/public/stylesheets"
      asset = Juicer::Asset.new "../images/logo.png", :context => context

      assert_equal context, asset.options[:context]
    end
  end
  ...
  context "asset absolute path" do
    ...
    should "return absolute path from relative path and document root" do
      context = "/var/www/public/stylesheets"
      document_root = "/var/www/public"
      asset = Juicer::Asset.new "../images/logo.png", :context => context, :document_root => document_root
    ...
    should "return absolute path with host from relative path and document root" do
      context = "/var/www/public/stylesheets"
      document_root = "/var/www/public"
      options = { :context => context, :document_root => document_root, :host => "localhost" }
      asset = Juicer::Asset.new "../images/logo.png", options
    ...
    should "return absolute path from absolute path" do
      context = "/var/www/public/stylesheets"
      document_root = "/var/www/public"
      options = { :context => context, :document_root => document_root }
  ...
  context "relative path" do
    should "raise exception if context is missing" do
      asset = Juicer::Asset.new "../images/logo.png", :context => nil
    ...
    should "return relative path from relative path" do
      path = "../images/logo.png"
      asset = Juicer::Asset.new path, :context => "/var/www/public/stylesheets"
    ...
    should "return relative path from absolute path" do
      path = "/images/logo.png"
      asset = Juicer::Asset.new path, :document_root => "/var/www/public", :context => "/var/www/public/stylesheets"
  ...
  context "asset filename" do
    should "raise exception with relative path without context" do
      asset = Juicer::Asset.new "../images/logo.png", :context => nil
    ...
    should "return filename from relative path and context" do
      asset = Juicer::Asset.new "../images/logo.png", :context => "/var/www/public/stylesheets"
  ...
  context "file helpers" do
    ...
    should "return file dirname" do
      ...
      assert_equal "#{context}images", asset.dirname
    end
